...
<body>
  ...
  <article>
    <div class="l_box f_l">
  	    ...
  	    <div id="slide-holder">
    		   <div id="slide-runner">
      		    <a href="/" target="_blank">
      			      <img id="slide-img-1" src="/Public/Home/img/a1.jpg">
      			  </a>
      			  <a href="/" target="_blank">
      			      <img id="slide-img-2" src="/Public/Home/img/a2.jpg">
      			  </a>
      			  <a href="/" target="_blank">
      			      <img id="slide-img-3" src="/Public/Home/img/a3.jpg">
      			  </a>
      			  <a href="/" target="_blank">
      			      <img id="slide-img-4" src="/Public/Home/img/a4.jpg">
      			  </a>
	   ...
	   <div class="topnews">
  	    <h2>文章推荐</h2>
        <?php if(is_array($artList)): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="blogs">
    		      <figure>
    			   ...
    			   <ul>
    			      ...
    			      <p class="autor">
      				    <span class="lm f_l">
      					    <a href="/"><?php echo ($vo["a_keyword"]); ?></a>
      					 </span>
