  	   ...
  	   <div class="topnews">
          ...
          <?php if(($num > 0)): ?><div class="board">
              ...
              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="bList">
                     <div class="lItem">
                         <img src="<?php echo ($vo["b_img"]); ?>" class="logo">
                         <div class="lCont">
                            <p class="p1">
                              <span class="s1"><b class="name"><?php echo ($vo["b_name"]); ?></b>[<?php echo (getIp($vo["b_ip"])); ?>]</span>
                              <span class="s2"><?php echo (getTime($vo["b_time"])); ?></span>
                            </p>
                            <p class="p2"><?php echo (reFace($vo["b_content"])); ?></p>
                         </div>
                     </div>
                     <?php if(!empty($vo['b_retime'])): ?><div class="lItem rItem">
                       <img src="/Public/Home/img/photo.jpg" class="logo">
                       <div class="lCont">
                          <p class="p1">
                            <span class="s1"><b class="name"><?php echo ($vo["b_rename"]); ?></b>回复<b class="name1"><?php echo ($vo["b_name"]); ?></b></span>
                            <span class="s2"><?php echo (getTime($vo["b_retime"])); ?></span>
                          </p>
                          <p class="p2"><?php echo (reFaceMy($vo["b_recontent"])); ?></p>
                       </div>
                     </div><?php endif; ?>
