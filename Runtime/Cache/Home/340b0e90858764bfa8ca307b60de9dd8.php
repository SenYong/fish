...
<body class="user-select">
   ...
   <div class="content">
       <div class="lt">      
          <p class="artHead"><a href="">首页</a>  /  相册</p>
          <div class="sayList">
              <?php if(is_array($albumList)): $i = 0; $__LIST__ = $albumList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('/albuminfo-'.$vo['al_id']);?>"><img src="<?php echo ($vo["al_img"]); ?>" class="album"></a><?php endforeach; endif; else: echo "" ;endif; ?>
          </div>
       </div>
       <div class="rt">
   <div class="rtItem">
