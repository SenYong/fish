  ...
  <article>
    <div class="l_box f_l">
  	   <div class="topnews">
    	    <h2>
        	   <span>
        	     <?php if(is_array($cat)): $i = 0; $__LIST__ = $cat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('/cat-'.$vo['c_id']);?>"><?php echo ($vo["c_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
        	   </span>	 
      	     <a href="<?php echo U('/article');?>" style="color:red;">技术心得</a>
    	    </h2>
          <div id="list">
