        ...
        <ul class="nav nav-sidebar">
            ...
            <li class="<?php echo ($picture); ?>"><a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">图片管理</a>
              <ul class="dropdown-menu" aria-labelledby="settingMenu">
                 ...
                 <li role="separator" class="divider"></li>
                 <li><a href="/Admin/Article/artContentList">图片列表</a></li>  
              </ul>
            </li>
        </ul>
    </aside>
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="article-title"><?php echo ($vo["al_name"]); ?></td> 
                    <td class="hidden-sm"><img src="<?php echo ($vo["al_img"]); ?>"></td>             
                    <td class="hidden-sm"><?php echo ($vo["al_content"]); ?></td>
                    <td><?php echo (getTime($vo["al_time"])); ?></td>
                    <?php if($vo['al_show'] == 0): ?><td>是</td>
                    <?php else: ?>
                       <td>否</td><?php endif; ?>
                    <td>
                       <a href="<?php echo U('/Admin/Album/edit',array('id'=>$vo['al_id']));?>">修改</a> 
