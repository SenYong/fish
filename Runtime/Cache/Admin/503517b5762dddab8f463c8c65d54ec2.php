          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                    <td><?php echo ($k); ?></td>
                    <td class="article-title"><?php echo ($vo["sc_name"]); ?></td>              
                    <td class="hidden-sm"><?php echo (reFace($vo["sc_content"])); ?></td>
                    <td><?php echo (date("Y-m-d H:i:s",$vo["sc_time"])); ?></td>
                    <?php if(empty($vo['sc_retime'])): ?><td class="not">否</td>
                    <?php else: ?>
                       <td>是</td><?php endif; ?>
                    <td>
                       <a href="<?php echo U('/Admin/Say/sayContentEdit',array('id'=>$vo['sc_id']));?>">回复</a> 
