    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="add-article-form">
          <div class="col-md-9">
            <?php if(empty($info['a_id'])): ?><h1 class="page-header">发布新文章</h1>
            <?php else: ?>
            ...
            <div class="form-group">
              ...
              <input type="text" id="article-title" name="title" class="form-control" placeholder="在此处输入标题" required autofocus autocomplete="off" value="<?php echo ($info["a_name"]); ?>">
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <script id="article-content" name="content" type="text/plain"><?php echo (html_entity_decode($info["a_content"])); ?></script>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>描述</span></h2>
              <div class="add-article-box-content">
              	<textarea class="form-control" name="describe" autocomplete="off" id="desc"><?php echo ($info["a_desc"]); ?></textarea>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  <?php if(is_array($tagList)): $i = 0; $__LIST__ = $tagList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(empty($info['a_id'])): ?><li>
                            <label>
                               <input name="category" type="radio" value="<?php echo ($vo["c_id"]); ?>"><?php echo ($vo["c_name"]); ?> 
                            </label>
                          </li>
                      <?php else: ?>
                          <li>
                            <label>
                               <input name="category" type="radio" value="<?php echo ($vo["c_id"]); ?>" <?php if(($info['pid']) == $vo['c_id']): ?>checked<?php endif; ?> ><?php echo ($vo["c_name"]); ?> 
                            </label>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="输入新标签" name="tags" autocomplete="off" id="keywords" value="<?php echo ($info["a_keyword"]); ?>">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="点击按钮选择图片" id="pictureUpload" name="titlepic" autocomplete="off" value="<?php echo ($info["a_img"]); ?>" disabled>
              </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p>
                   <label>公开度：</label>
                   <input type="radio" name="visibility" value="0" <?php if(($info['a_show']) == "0"): ?>checked<?php endif; ?> />公开 
                   <input type="radio" name="visibility" value="1" <?php if(($info['a_show']) == "1"): ?>checked<?php endif; ?> />加密
                </p>
                <p>
                   <label>原创：</label>
                   <input type="radio" name="org" value="0" <?php if(($info['a_original']) == "0"): ?>checked<?php endif; ?> />是 
                   <input type="radio" name="org" value="1" <?php if(($info['a_original']) == "1"): ?>checked<?php endif; ?> />不是
                </p>
                <p>
                   <label>发布于：</label>
              ...
              <div class="add-article-box-footer">
                 ...
                 <?php if(empty($info['a_id'])): ?><button class="btn btn-primary" type="submit" name="submit" id="addArt">新增</button>
                 <?php else: ?>
                    <button class="btn btn-primary" type="submit" name="submit" id="editArt">修改</button><?php endif; ?>
              </div>
            </div>
          </div>
        </div>
