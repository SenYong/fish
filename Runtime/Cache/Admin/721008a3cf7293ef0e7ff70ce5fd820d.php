...
<div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
        ...
        <ul class="nav nav-sidebar">
            <li class="<?php echo ($art); ?>"><a class="dropdown-toggle" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">发布内容</a>
            ...
            <li class="<?php echo ($artlist); ?>"><a class="dropdown-toggle" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">内容管理</a>
              <ul class="dropdown-menu" aria-labelledby="userMenu">
                <li><a href="/Admin/Article/artList">文章列表</a></li>
                <li role="separator" class="divider"></li>
                <li><a href="loginlog.html">说说列表</a></li>
              </ul>
            </li>
            <li class="<?php echo ($cat); ?>"><a class="dropdown-toggle" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">栏目</a>
              <ul class="dropdown-menu" aria-labelledby="userMenu">
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="article-title"><?php echo ($vo["a_name"]); ?></td>              
                    <td class="hidden-sm"><?php echo ($vo["a_keyword"]); ?></td>
                    <td><?php echo (getTime($vo["a_time"])); ?></td>
                    <?php if($vo['c_show'] == 0): ?><td>是</td>
                    <?php else: ?>
                       <td>否</td><?php endif; ?>
                    <td>
                       <a href="<?php echo U('/Admin/Article/edit',array('id'=>$vo['a_id']));?>">修改</a> 
                       <a class="deletes">删除</a>
                       <input type="hidden" value="<?php echo ($vo["c_id"]); ?>">
                    </td>
