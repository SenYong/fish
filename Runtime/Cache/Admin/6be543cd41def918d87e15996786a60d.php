    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="row placeholders">
          <div class="col-xs-6 col-sm-3 placeholder">
            <h4>说说</h4>
            <span class="text-muted"><?php echo ($sayNum); ?> 条</span> 
          </div>
          <div class="col-xs-6 col-sm-3 placeholder">
            <h4>文章</h4>
            <span class="text-muted"><?php echo ($articleNum); ?> 条</span> 
          </div>
          <div class="col-xs-6 col-sm-3 placeholder">
            <h4>日志</h4>
            <span class="text-muted"><?php echo ($logNum); ?> 条</span> 
          </div>
          <div class="col-xs-6 col-sm-3 placeholder">
            <h4>留言板</h4>
            <span class="text-muted"><?php echo ($boardNum); ?> 条</span> 
          </div>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            <tr>
              <td>登录者: <span><?php echo (session('uname')); ?></span>，这是您第 <span><?php echo ($userInfo["u_num"]); ?></span> 次登录</td>
            </tr>
            <tr>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              <td>程序版本:</td>
              <td class="version">thinkphp3.2</td>
              <td>上传文件:</td>
