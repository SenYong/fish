      ...
      <div class="row">
        <div class="add-article-form">
          <div class="col-md-9">
              ...
              <input type="hidden" value="<?php echo (session('uname')); ?>" id="b_rename">
              <input type="hidden" value="<?php echo (session('uimg')); ?>" id="b_reimg">
              <input type="hidden" value="<?php echo ($info["b_id"]); ?>" id="b_id">
              <h2 class="add-article-box-title"><span>用户名</span></h2>
              <div class="form-group">
                <div id="article-title" class="form-control"><?php echo ($info["b_name"]); ?></div>
              </div>
              <div class="add-article-box">
                <h2 class="add-article-box-title"><span>评论内容</span></h2>
                <div class="add-article-box-content">
                  <div class="form-control" id="desc"><?php echo (html_entity_decode(reFace($info["b_content"]))); ?></div>
                </div>
              </div>
              <h2 class="add-article-box-title"><span>评论时间</span></h2>
              <div class="form-group"> 
                 <div id="article-title" class="form-control"><?php echo (getTime($info["b_time"])); ?></div>
              </div>
              <h2 class="add-article-box-title"><span>回复内容</span></h2>
              <div class="form sayForm" id="comment">
                  <div class="warp_text">
                      <textarea id="content-text" placeholder="回复些什么呢..."><?php echo ($info["b_recontent"]); ?></textarea>
                  </div>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<p>
                   <label>状态：</label>
                   <?php if(empty($info['b_retime'])): ?><span class="article-status-display">未回复</span>
                   <?php else: ?>
                      <span class="article-status-display">已回复</span><?php endif; ?>
                </p>
                <p>
                   <?php if(!empty($info['b_retime'])): ?><label>回复于:</label>
                       <span class="article-time-display">
                          <input style="border: none;" type="datetime" name="time" value="<?php echo (getTime($info['b_retime'])); ?>" disabled/>
                       </span><?php endif; ?>
                </p>
              </div>
